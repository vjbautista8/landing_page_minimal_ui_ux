...
const StyledRoot = styled('div')(({ theme }) => ({
  ...bgGradient({
    ...
    imgUrl: `${APP_URL}/assets/background/overlay_3.jpg`,
  }),
  width: '100%',
  height: '100vh',
  position: 'relative',
        ...
        <Stack spacing={2} direction="row" justifyContent="center">
          {['figma', 'js', 'ts', 'nextjs', 'vite'].map((platform) => (
            <m.div key={platform} variants={varFade().in}>
              <Box
                component="img"
                src={`${APP_URL}/assets/icons/platforms/ic_${platform}.svg`}
    ...
    >
      ...
      >
        <Box
          ...
          src={
            isLight
              ? `${APP_URL}/assets/images/home/hero/light_1.jpg`
              : `${APP_URL}/assets/images/home/hero/dark_1.jpg`
          }
      ...
      >
        <Box
          ...
          src={
            isLight
              ? `${APP_URL}/assets/images/home/hero/light_2.jpg`
              : `${APP_URL}/assets/images/home/hero/dark_2.jpg`
          }
          sx={{ position: 'absolute', mt: -5 }}
        />
        <Box
